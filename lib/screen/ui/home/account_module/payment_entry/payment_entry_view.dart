...
// import 'package:digitalerp/screen/ui/home/account_module/payment_entry/payment_entry_controller.dart';
...
//
// class PaymentEntryView extends StatelessWidget {
//   final bool? isPayment;
//   final String? title;
//
//   const PaymentEntryView({Key? key, required this.isPayment, required this.title})
//       : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     return GetBuilder<PaymentEntryController>(
//       init: PaymentEntryController(),
...
//                               _dateView(context, controller.selectedDate, controller),
...
//                                 itemCount: isPayment ?? true
//                                     ? controller.paymentOptionList.length
//                                     : controller.paymentOption2List.length,
...
//   }
//
//   Widget _dateView(BuildContext context, String value, PaymentEntryController ctrl) {
//     return InkWell(
...
//
//   Widget paymentCard(
//     PaymentEntryController controller,
//     int index,
//   ) {
//     return SizedBox(
//       height: 60,
...
//   }
//
//   Widget paymentCard2(PaymentEntryController controller, int index, BuildContext context) {
//     return SizedBox(
...
//   }
//
//   Widget _dropdown(PaymentEntryController controller) {
...
//   }
//
//   Widget _cashAndBankLedgerDropdown(PaymentEntryController controller) {
//     return DropdownButtonHideUnderline(
...
//   }
//
//   _showImageDialog(PaymentEntryController value) {
...
//   }
//
//   void _getImage(ImageSource source, PaymentEntryController value) async {
//     Get.back();
...
const Color _kAccent = purpleColor;
...
class PaymentEntryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<PaymentEntryController>(
      ...
      builder: (controller) => Scaffold(
        ...
        appBar: _buildAppBar('Payment Entry'),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _card(children: [
                      _label('Date'),
                      _dateTile(controller.selectedDate,
  ...
  Widget _customerDropdown(PaymentEntryController controller) =>
  ...
  Widget paymentCard(PaymentEntryController controller, int index) {
  ...
  Widget paymentCard2(
      PaymentEntryController controller, int index, BuildContext context) {
    final isSelected = controller.selectedIndex == index;
    return GestureDetector(
      onTap: () => controller.setSelectedIndex(index),
      child: Container(
          ...
          if (isSelected) ...[
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                    borderSide:
                    const BorderSide(color: Color(0xFFE4E7EF))),
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(children: [
                  Expanded(
                      child: Text(controller.selectedChequeDate,
                          style: const TextStyle(
