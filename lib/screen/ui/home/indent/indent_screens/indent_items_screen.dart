...
class _AddItemFormState extends State<_AddItemForm> {
  ...
  Future<void> _onItemSelected(
    ...
    if (item != null) {
      ...
      // Fetch stock at site
      final stock =
      await ctrl.fetchStockAtSite(int.tryParse(item.id) ?? 0);
      if (mounted) {
        setState(() {
                ...
                if (_selectedItem != null &&
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color:
                          indGreenColor.withValues(alpha: 0.4)),
                    ),
                    child: Text(
...
class _ItemCardState extends State<_ItemCard> {
  ...
  void initState() {
    ...
    _qtyCtrl = TextEditingController(
        text: widget.item.indentQty.toStringAsFixed(0));
          ...
          Padding(
            ...
            child: Column(children: [
              Row(children: [
                        ...
                        Row(children: [
                          _qtyBtn(
                            ...
                            onTap: () {
                              ...
                              _qtyCtrl.text =
                                  item.indentQty.toStringAsFixed(0);
                            },
                          ),
                          const SizedBox(width: 8),
                          Expanded(
                ...
                Expanded(
                  child: IndentField(
                    ...
                    onChanged: (v) {
                      widget.ctrl.updateItemRate(
                          item, double.tryParse(v) ?? 0);
                    },
                  ),
                ),
              ]),
              ...
              IndentField(
                ...
                maxLines: 3,
                onChanged: (v) =>
                    widget.ctrl.setItemDescription(item, v),
              ),
            ]),
          ),
        ],
  ...
  Widget _infoPill(
      IconData icon, String text, Color fg, Color bg) {
    return Container(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(8),
            border:
            Border.all(color: indBlueColor.withValues(alpha: 0.3))),
        alignment: Alignment.center,
