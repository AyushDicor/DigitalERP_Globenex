...
class ManagerLeaveHistoryFilterController extends AppBaseController {
  ManagerLeaveHistoryController managerLeaveHistoryController = Get.find<ManagerLeaveHistoryController>();
  ...
  void onApplyFilter() {
    ...
    if (isValidate()) {
      ...
      managerLeaveHistoryController.fromDate = fromDate;
      managerLeaveHistoryController.toDate = toDate;
      managerLeaveHistoryController.getPendingLeaveList();
      managerLeaveHistoryController.selectedMonth = selectedMonthDropdownValue;
      Get.back();
    }
  }
}
