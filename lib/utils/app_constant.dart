...
const Color newBlueColor        = Color(0xFF4361EE); // Primary CTA
const Color newBlueLightColor   = Color(0xFFEEF1FF); // Light blue bg
...
const Color purpleColor           = Color(0xFF5471E6);
const Color blueColor             = Color(0xFF2563EB);
const Color grTopColor            = Color(0xFFEFF6FF);
const Color grBottomColor         = Color(0xFF2563EB);
const Color darkOrangeColor       = Color(0xFFF07F1B);
const Color orangeColor           = Color(0xFFF07F1B);
...
const LinearGradient gr2 = LinearGradient(
  colors: grad2,
  begin: Alignment.topCenter,
  end: Alignment.bottomCenter,
);

const LinearGradient gr2Opp = LinearGradient(
  colors: grad2,
  begin: Alignment.bottomCenter,
  end: Alignment.topCenter,
);
...
class AppString {
  ...
  static const String pleaseEnterValidMobileTxt =
  ...
  static const String pleaseEnterContactPersonTxt =
      'Please Enter Contact Person';
  static const String pleaseEnterEmailIdTxt = 'Please Enter Email ID';
  static const String pleaseEnterValidEmailIdTxt =
  ...
  static const String pleaseEnterConfirmPasswordTxt =
  ...
  static const String locationPermissionDeniedTxt =
      'Location permission denied';
  static const String locationPermissionGrantedTxt =
      'Location permission granted';
  static const String selectGroupTxt = 'Please select group';
  static const String selectStatusTxt =
      'Please select any status from Dropdown';
  ...
  static const String companyPendingTxt =
      'Selected company is pending for approval';
  ...
  static const String pleaseEnterAlternateMobileNo =
      'Please Enter Alternate Mobile No';
  static const String pleaseEnterMailId = 'Please Enter Email Id';
  static const String pleaseEnterWebsite = 'Please Enter Website';
  static const String pleaseEnterCompanyAddress =
      'Please Enter Company/Address';
  static const String pleaseEnterPhoneNo = 'Please Enter Phone No';
  static const String pleaseEnterBusinessNature =
      'Please Enter Business Nature';
  ...
  static const String pleaseEnterShippingAddress =
  ...
  // static const String peaseEnterDetail
  ...
  static const String enterRequirementSpecification =
      'Enter Requirement Specification';
...
class NumberFormatter {
  static formatter(String numberToFormat) {
    return NumberFormat.compact().format(num.parse(numberToFormat));
  }
}
